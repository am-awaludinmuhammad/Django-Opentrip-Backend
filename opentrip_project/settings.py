"""
Django settings for opentrip_project project.
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Trip API',
    'DESCRIPTION': 'API documentation for the Trip API',
    'VERSION': '1.0.0',
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=int(os.getenv('ACCESS_TOKEN_LIFETIME', 1))),
...
ROOT_URLCONF = 'opentrip_project.urls'
